            ...
            <table class="table table-hover table-bordered">
              <thead class="table-active">
                <tr>
                  ...
                  <th>Name</th>
                  <td align="center"><strong># Roles</strong></td>
              ...
              <tbody>
                ...
                <tr>
                  ...
                  @endif
                  <td align="center">
                    <a href="{{route('laratrust.roles-assignment.edit', ['roles_assignment' => $user->getKey(), 'model' => $modelKey])}}" class="btn btn-sm btn-warning">Edit</a>
                  </td>
                </tr>
                @endforeach
              </tbody>
