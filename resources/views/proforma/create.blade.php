...
<style>
    ...
    .ss-main .ss-values .ss-single {
        font-size:smaller; font-weight: 400;color: var(--bs-body-color);
    }
</style>
                    ...
                    <form action="{{ route('proforma.store') }}" name="proforma" method="POST">
                        ...
                        <div class="row mt-2">
                            ...
                            <table width="100%" class="mt-2 table table-bordered">
                                ...
                                <tr>
                                    <td colspan="10" class="text-right" valign="middle"><strong>Sub Amount</strong></td>
                                ...
                                <tr>
                                    <td align="right" colspan="10" align="right" class="text-right" valign="middle"><strong>Less
                                            <input type="text" name="scheme" id="scheme" value="0" size="5" class="text-center"
                                            style="font-size: 0.7rem !important;  border:1px solid;border-radius:5px; height:32px"> %
                                    </td>
                                ...
                                <tr>
                                    <td colspan="10" align="right" class="text-right" valign="middle"><strong>Total Amount</strong></td>
                                 ...
                                 <tr>
                                    ...
                                    <td>&nbsp;</td>  
                                    <td align="right" valign="middle" class="text-right"><strong>Freight/Courier</strong></td>                                   
                                    <td align="right" valign="middle" class="text-right"><input type="text" name="freight_charges" id="freight_charges" value="" class="text-center" size="15" style="border:1px solid;border-radius:5px; height:32px"></td>
                                </tr>
                                <tr>
                                    <td colspan="9">&nbsp;</td>
                        ...
                        <div class="col-md-11 mt-4 d-md-flex justify-content-md-end g-1">
...
<script>
    $(document).ready(function() {
        ...
        $('#add-item-btn').click(function() {
            ...
            $('#sku_add, #navid_add, #itemname_add, #itemnumber_add, #dimension_add, #casepack_add, #ordercase_add, #price_add, #amount_add, #itemgst_add').val('');
